...
MIRAI is a web application designed to . The application aims to provide users with a seamless experience to . It utilizes React and Next.JS to create a dynamic and responsive Single Page Application (SPA).
